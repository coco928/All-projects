...
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color) {
	if(x1<0||y1<0||x2>= LCD_W||y2>=LCD_H) return;
...
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2,u16 color)
{
	...
	if(x2>=LCD_W||y2>=LCD_H) return;
	LCD_DrawLine(x1,y1,x2,y1,color);
	LCD_DrawLine(x1,y1,x1,y2,color);
	LCD_DrawLine(x1,y2,x2,y2,color);
	LCD_DrawLine(x2,y1,x2,y2,color);
}
void LCD_DrawTriangle(u16 x1, u16 y1,u16 color)
{
	LCD_DrawLine(x1,y1,x1+3,y1+4,color);
	LCD_DrawLine(x1,y1,x1+6,y1,color);
	LCD_DrawLine(x1+3,y1+4,x1+6,y1,color);
